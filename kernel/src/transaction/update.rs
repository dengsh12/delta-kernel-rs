...
impl Transaction {
    ...
    pub(crate) fn try_new_existing_table(
        ...
        // TODO(#3240): Validate that delta.enableRowTracking=true has the required protocol
        // support. Materialized names must be distinct and must not collide with physical
        // data columns.
